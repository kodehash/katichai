...
func (s *DiffSampler) SampleDiff(diff *git.Diff, analysisResults map[string]*analysis.FileAnalysis) (*SampledDiff, *SamplingReport) {
...
func (s *DiffSampler) calculateRiskScores(files []*git.DiffFile, analysisResults map[string]*analysis.FileAnalysis) []FileRisk {
...
func (s *DiffSampler) sampleFile(file *git.DiffFile, analysis *analysis.FileAnalysis, tokenBudget int) *SampledFile {
	sampled := &SampledFile{
		Path:      file.Path,
		Status:    file.Status,
...
func (s *DiffSampler) extractSignatures(file *git.DiffFile, analysis *analysis.FileAnalysis) string {
	var sb strings.Builder
